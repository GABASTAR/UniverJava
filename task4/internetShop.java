...
public class internetShop {
    enum Product {
        ...
        static final String RUB_SYMBOL = " RUB";
...
class ProductCatalog {
    private String name;
    private final ArrayList<internetShop.Product> products = new ArrayList<>();
    ...
    public ArrayList<internetShop.Product> getProducts() {
        return products;
    }

    public void addProduct(internetShop.Product product) {
        products.add(product);
    }

    public void printCatalog() {
        int i = 1;
        for (internetShop.Product product : products) {
...
class CartProduct {
    private internetShop.Product product;
    private int quantity;

    public internetShop.Product getProduct() {
        return product;
    }

    public void setProduct(internetShop.Product product) {
...
class Cart {
    ...
    public void printCart() {
        ...
        for (CartProduct product : products) {
            System.out.printf("%d. %s %d x %.2f%s\n", i, product.getProduct().name(), product.getQuantity(), product.getProduct().getPrice(), internetShop.Product.RUB_SYMBOL);
            i++;
        }
    }
}
